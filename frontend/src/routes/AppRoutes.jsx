...
const AdsMapPage              = lazy(() => import('../pages/AdsMapPage.jsx'))
...
// Admin pages (role: ADMIN, protected by AdminGuard)
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route
          path="/admin"
          element={<AdminGuard><AdminOverviewPage /></AdminGuard>}
        />
        <Route
          path="/admin/users"
        ...
        <Route
          path="/admin/ads"
          element={<AdminGuard><AdminAdsPage /></AdminGuard>}
        />
        <Route
          path="/admin/categories"
          element={<AdminGuard><AdminCategoriesPage /></AdminGuard>}
        />
        <Route
          path="/admin/subscriptions"
          element={<AdminGuard><AdminSubscriptionsPage /></AdminGuard>}
        />
        <Route
          path="/admin/revenue"
          element={<AdminGuard><AdminRevenuePage /></AdminGuard>}
        />
        <Route
          path="/admin/analytics"
          element={<AdminGuard><AdminAnalyticsPage /></AdminGuard>}
        />
