          ...
          <form onSubmit={handleCreate} className="space-y-5">
            ...
            <FormField label={t('profile.edit.profileTypeLabel')}>
              <Select value={form.profile_type} onChange={set('profile_type')}>
                {Object.entries({
                  PERSONAL: t('profile.edit.profileTypes.PERSONAL'),
                  PROFESSIONAL: t('profile.edit.profileTypes.PROFESSIONAL'),
                  FREELANCER: t('profile.edit.profileTypes.FREELANCER'),
                  SHOP: t('profile.edit.profileTypes.SHOP'),
                  BUSINESS: t('profile.edit.profileTypes.BUSINESS'),
                  COMPANY: t('profile.edit.profileTypes.COMPANY'),
                  ORGANIZATION: t('profile.edit.profileTypes.ORGANIZATION'),
      ...
      <div className="max-w-2xl space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <section className="bg-surface border border-border rounded-xl p-5 space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <FormField label={t('profile.edit.displayNameLabel')} required>
                <Input value={form.display_name} onChange={set('display_name')} placeholder={t('profile.edit.displayNamePlaceholder')} required />
              </FormField>
              <FormField label={t('profile.edit.profileTypeLabel')}>
                <Select value={form.profile_type} onChange={set('profile_type')}>
                  {Object.entries({
            ...
            <FormField
              label={t('profile.edit.categoryLabel')}
              hint={t('profile.edit.categoryHint')}
            >
              <Select value={form.category_id || ''} onChange={set('category_id')}>
                <option value="">{t('profile.edit.categoryPlaceholder')}</option>
                {categoryOptions.map(opt => (
            ...
            <FormField label={t('profile.edit.headlineLabel')} hint={t('profile.edit.headlineHint')}>
              <Input value={form.headline} onChange={set('headline')} placeholder={t('profile.edit.headlinePlaceholder')} maxLength={150} />
            </FormField>
          ...
          <section className="bg-surface border border-border rounded-xl p-5 space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <FormField label={t('profile.edit.phoneLabel')}>
                <Input value={form.contact_phone} onChange={set('contact_phone')} placeholder={t('profile.edit.phonePlaceholder')} type="tel" />
              </FormField>
              <FormField label={t('profile.edit.emailLabel')}>
                <Input value={form.contact_email} onChange={set('contact_email')} placeholder={t('profile.edit.emailPlaceholder')} type="email" />
              </FormField>
              <FormField label={t('profile.edit.whatsappLabel')}>
                <Input value={form.whatsapp} onChange={set('whatsapp')} placeholder={t('profile.edit.phonePlaceholder')} type="tel" />
              </FormField>
              <FormField label={t('profile.edit.telegramLabel')}>
                <Input value={form.telegram_username} onChange={set('telegram_username')} placeholder={t('profile.edit.telegramPlaceholder')} />
              </FormField>
              <FormField label={t('profile.edit.websiteLabel')} className="sm:col-span-2">
                <Input value={form.website_url} onChange={set('website_url')} placeholder={t('profile.edit.websitePlaceholder')} type="url" />
              </FormField>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <FormField label={t('profile.edit.phoneVisibility')}>
                <Select value={form.phone_visibility} onChange={set('phone_visibility')}>
                  {Object.entries({
                    PUBLIC:    t('profile.edit.visibility.PUBLIC'),
                    LOGGED_IN: t('profile.edit.visibility.LOGGED_IN'),
                    HIDDEN:    t('profile.edit.visibility.HIDDEN'),
                  }).map(([v, l]) => <option key={v} value={v}>{l}</option>)}
                </Select>
              </FormField>
          ...
          <div className="flex items-center gap-3">
            <Button type="submit" variant="primary" loading={updateMutation.isPending}>{t('profile.edit.saveChanges')}</Button>
            {saved && (
