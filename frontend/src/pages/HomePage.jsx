...
const FEATURED_CITIES = [
  { name: 'Addis Ababa', sub: 'Capital · Most listings' },
  { name: 'Gondar',      sub: 'Northern Ethiopia' },
  { name: 'Hawassa',     sub: 'Southern Ethiopia' },
  { name: 'Bahir Dar',   sub: 'Amhara Region' },
  { name: 'Mekelle',     sub: 'Tigray Region' },
  { name: 'Dire Dawa',   sub: 'Eastern Ethiopia' },
  { name: 'Jimma',       sub: 'Oromia Region' },
  { name: 'Adama',       sub: 'Oromia Region' },
]
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      ...
      >
        ...
        {/* Divider */}
        <div
          className="hidden sm:block w-px bg-border self-stretch my-3"
          aria-hidden="true"
        />
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto px-5 sm:px-8 pt-16 pb-20 sm:pt-24 sm:pb-28 text-center">
            ...
            >
              ...
              <br className="hidden sm:block" />
              <span className="text-ink/70">around you.</span>
            </h1>
            ...
            <div className="animate-fade-up delay-150 flex flex-col items-center gap-1.5 mb-10">
              ...
              ">
                Professionals, shops, services &amp; freelancers —
            ...
            {isLoading ? (
              ...
              <div className="text-center py-20 text-ink-2">
                ...
                <p className="text-[13px] text-ink-3">
                  Be the first to advertise yourself on GebetaPro.
                </p>
              </div>
            ) : (
              <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-10 lg:gap-16 items-start">
              ...
              <div>
                ...
                <p className="text-[14px] text-ink-2 leading-relaxed max-w-sm mb-6">
                  GebetaPro connects you with skilled people and
                  growing businesses in every major Ethiopian city.
                </p>
                <button
                  onClick={() => navigate('/directory')}
                  className="
                ...
                >
                  Browse all locations <ArrowUpRight size={14} />
                </button>
              </div>

              {/* Right: city grid */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                {FEATURED_CITIES.map(({ name, sub }) => (
                  <button
                    key={name}
                    type="button"
                    onClick={() =>
            ...
            >
              ...
              <div className="relative z-10 p-8 sm:p-12 flex flex-col justify-center">
                ...
                <p className="text-[14px] text-white/50 leading-relaxed mb-8 max-w-sm">
                  Browse businesses, professionals, and services
                  plotted on an interactive map of Ethiopia.
                  Filter by category, zoom to your area.
                </p>
                <div>
                  <Button
                    variant="primary"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-[15px] text-white/45 leading-relaxed max-w-md mb-10">
                  Create a rich profile, showcase what you offer, collect
                  reviews, and get discovered by people looking for exactly
                  what you do — across Ethiopia.
                </p>
