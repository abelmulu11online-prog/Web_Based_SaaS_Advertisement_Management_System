...
import { useCreateAdvertisement, useCategories } from '../features/advertisements/hooks/useAdvertisements.js'
      ...
      <div className="max-w-xl mx-auto">
        ...
        {step === 3 && (
          <div className="flex flex-col gap-4">
            ...
            <FormField label="Address / Area" hint="e.g. Bole, Addis Ababa or Gondar City Centre">
              <Input
                value={form.address}
            ...
            <div className="grid grid-cols-2 gap-3">
              <FormField label="Latitude" hint="Optional GPS coordinate">
                <Input
                  type="number"
                  step="any"
                  value={form.latitude}
              ...
              <FormField label="Longitude" hint="Optional GPS coordinate">
                <Input
                  type="number"
                  step="any"
