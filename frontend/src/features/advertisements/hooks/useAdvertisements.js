...
/**
 * Fetch categories as a flat list (no tree nesting).
 * Useful for simple dropdowns and button grids.
 */
export function useCategoriesFlat() {
  return useQuery({
    queryKey: [...adsKeys.categories, 'flat'],
    queryFn: () => adsService.getCategories(true),
