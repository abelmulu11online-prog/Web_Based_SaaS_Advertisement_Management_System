...
/**
 * GET /api/ads/map
 * Return all published advertisements that have coordinates — minimal payload
 * for map pin rendering (id, title, lat, lng, price, image).
 *
 * No authentication required.
 */
export const listMapPins = asyncHandler(async (req, res) => {
  const pins = await adsService.listMapPins()
  sendSuccess(res, 'Map pins retrieved successfully', pins)
})
