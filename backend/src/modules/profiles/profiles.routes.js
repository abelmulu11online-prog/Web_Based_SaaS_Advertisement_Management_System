...
import * as usersCtrl from '../users/users.controller.js'
import {
  slugParamSchema,
...
// ── Verification workflow (also registered here for reliability) ──────────────
// These routes are also in users.routes.js. Having them in both routers
// mounted at /api/profile ensures they are always reachable regardless of
// Express router processing order.
dashboardProfileRouter.post(
  '/verification-document/upload',
  uploadDocumentMiddleware,
  usersCtrl.uploadVerificationDocument,
)
dashboardProfileRouter.get('/verification-document',  usersCtrl.getMyVerificationDocument)
dashboardProfileRouter.post('/submit-review',         usersCtrl.submitForReview)
dashboardProfileRouter.post('/resubmit',              usersCtrl.resubmitForReview)
dashboardProfileRouter.post('/publish',               usersCtrl.publishProfile)
dashboardProfileRouter.post('/unpublish',             usersCtrl.unpublishProfile)
